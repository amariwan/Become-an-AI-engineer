...
\input{chapters/04_kontext_preise}
...
\input{chapters/05_openai_plattform}

\chapter{Token-Verwaltung}
\input{chapters/06_token_verwaltung}

\chapter{Prompt Design}
\input{chapters/07_prompt_design}
...
\input{chapters/08_rag_vector_datenbanken}

\chapter{AI Agenten}
\input{chapters/09_ai_agenten}

\chapter{Evaluation}
\input{chapters/10_evaluation}

\chapter{Multimodale KI -- Vision, Audio und Video}
\input{chapters/20_multimodale_ki}
...
\input{chapters/17_inferenz_optimierung}

\chapter{Model Customization -- Fine-Tuning und Adaptation}
\input{chapters/18_modellanpassung}

\chapter{Caching, Routing und Guardrails}
\input{chapters/19_caching_routing_guardrails}
...
\input{chapters/11_deployment_beobachtbarkeit}

\chapter{MLOps und der Modell-Lebenszyklus}
\input{chapters/21_mlops_modelllebenszyklus}

\chapter{KI-Sicherheit und Ethik}
\input{chapters/12_ki_sicherheit_ethik}

\chapter{Verantwortungsvolle KI und Governance}
\input{chapters/22_verantwortungsvolle_ki_governance}

\chapter{KI-Sicherheit}
\input{chapters/16_ki_sicherheit}
...
\input{chapters/14_praxisprojekte}

\chapter{Bewerbungsprozess}
\input{chapters/15_bewerbungsprozess}
