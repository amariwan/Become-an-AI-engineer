...
\praxishinweis{Multimodale Sicherheit ist kein nachträglicher Einbau. OCR-Injection-Check und Audio-Frequenz-Filter gehören in die Basis-Pipeline, nicht ins Monitoring-Dashboard. Baut den Input Guard bevor der erste User den Endpoint testet.}
...
\textbf{Nächster Schritt:} Im nächsten Teil des Buches tauchst du in die Produktion ein -- beginnend mit Evaluation und Metriken. Wie misst du, ob dein System wirklich gut arbeitet?
\endinput
