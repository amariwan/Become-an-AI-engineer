...
\begin{enumerate}[leftmargin=*]
    \item Erkläre drei konkrete Massnahmen gegen Halluzinationen in einem Produktivsystem.
    \item Wie würdest du Bias in einem LLM-basierten Recruiting-Tool erkennen und mitigieren?
    \item Was ist der EU AI Act und welche Konsequenzen hat er für AI Engineers?
    \item Wie gehst du mit personenbezogenen Daten in einer RAG-Pipeline um?
    \item Vergleiche die Safety-Ansätze von OpenAI, Anthropic und Google.
    \item Ein User beschwert sich über eine diskriminierende Antwort deines Chatbots. Was tust du?
\end{enumerate}
