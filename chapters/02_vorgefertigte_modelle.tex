...
\begin{itemize}
    ...
    \item \textbf{Knowledge Cutoff} Datum, bis zu dem die Trainingsdaten eines Modells aktuell sind. Modell mit aktuellem Cutoff hat keinerlei Wissen über Ereignisse danach.
...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Versioniere dein Modell}: Nutze explizite Modell-Strings (z.B. \texttt{gpt-4o-202X-XX-XX}), nicht generische (\texttt{gpt-4o}). API-Provider ändern das zugrundeliegende Modell hinter generischen Namen.
...
\autornotiz{
Nächstes Kapitel: Modell-Landschaft -- der Marktüberblick.
Da lernst du: Die vier Schichten des AI-Stacks (LLM, RAG, Agents, MCP). Closed Source (OpenAI, Anthropic, Google) vs. Open Source (Llama, Mistral, Qwen, DeepSeek). Multi-Provider-Routing als Standard. Entscheidungsmatrix für Modellwahl. Und warum Abstraction Layer von Tag 1 Pflicht ist.
}

\textbf{Nächster Schritt:} Mit diesem Verständnis der Foundation Models geht es weiter zur Modell-Landschaft -- der Überblick über Anbieter, Modelle und Routing-Strategien.
\endinput
