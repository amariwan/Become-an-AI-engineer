...
\autornotiz{
Nächstes Kapitel: Evaluation und Testing von LLM-Applikationen.
Da lernst du: Golden Sets, LLM-as-a-Judge, Tracing, Cost/Latency/Quality Metriken in Produktion messen. Und wie du Evaluation in CI/CD integrierst.
}
