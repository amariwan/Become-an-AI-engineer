...
\begin{enumerate}[leftmargin=*]
    \item Wie würdest du eine LLM-Anwendung für 10.000 tägliche User deployen?
    \item Erkläre den Unterschied zwischen vertikaler und horizontaler Skalierung bei LLM-Services.
    \item Wie würdest du die Kosten einer LLM-Anwendung um 50\% reduzieren?
    \item Was machst du, wenn die OpenAI-API ausfällt und dein Produkt davon abhängt?
    \item Welche Metriken würdest du in einem LLM-Produktionssystem überwachen?
    \item Vergleiche API-basiertes Deployment mit Self-hosted Deployment. Wann nimmst du was?
    \item Wie implementierst du Readiness-Probes f\"ur eine LLM-API, die kurzzeitig ausfallen kann?
    \item Dein LLM-Service hat nach einem Deployment plötzlich 5x h\"ohere Latenz. Was sind deine ersten Debug-Schritte?
    \item Wie würdest du einen Multi-Region-Failover f\"ur einen LLM-Service designen?
\end{enumerate}
