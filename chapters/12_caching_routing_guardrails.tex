...
\praxishinweis{PII-Redaktion vor dem LLM-Call ist kritisch. Sonst landen persönliche Daten im KV-Cache oder im Response Cache -- und werden an andere User ausgeliefert. Redigieren vor dem Caching, nicht danach.}
...
\textbf{Nächster Schritt:} Der Übergang von der Optimierung zur Anpassung -- im nächsten Kapitel geht es um Model Customization: Fine-Tuning und Adaptation.
\endinput
