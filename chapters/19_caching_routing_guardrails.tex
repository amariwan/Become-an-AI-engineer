...
\begin{enumerate}[leftmargin=*]
    ...
    \textbf{Antwort:} Formel: $(Hits \times LLM\_Cost) - (Total\_Calls \times Embedding\_Cost)$. Caching lohnt sich finanziell nur, wenn die Embedding-Inference drastisch günstiger ist als der gesparte LLM-Aufruf.
