...
\begin{praxishinweis}
LLM-as-a-Judge hat systematische Biases. Ein GPT-4o-Judge bevorzugt lange, ausführliche Antworten; Claude bevorzugt vorsichtige; Gemini bevorzugt Aufzählungen. Gegenmaßnahmen: Multi-Judge (3 Modelle, Majority Vote), Rubric-basierte Bewertung statt freier Skala, Position-Swapping bei Pairwise-Vergleichen.
\end{praxishinweis}
...
\begin{praxishinweis}
Evaluations-Pipelines verarbeiten oft sensitive Daten: User-Inputs aus Produktion, interne Dokumente, Ground-Truth-Antworten mit Geschäftsgeheimnissen. Golden Datasets gehören nie in öffentliche Repositories. Separate API-Keys mit Budget-Limits für Evals nutzen, nicht die Produktions-Keys.
\end{praxishinweis}
