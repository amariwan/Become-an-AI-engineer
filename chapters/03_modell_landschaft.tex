...
\autornotiz{
Nächstes Kapitel: OpenAI Platform im Detail.
Da lernst du: Chat Completions API, Structured Outputs, Streaming, Function Calling, Fine-Tuning, Batch API. Und warum Structured Outputs der Standard für jeden Production-Call sein sollten -- nicht optional.
}

\textbf{Nächster Schritt:} Mit diesem Überblick über die Modell-Landschaft geht es weiter zur OpenAI API -- dein Einstieg in die Praxis.
\endinput
