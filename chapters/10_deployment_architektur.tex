...
\label{chap:deployment_architektur}
...
Mid-Size mit PII-Daten & Self-hosted Llama/Mistral & Daten verlassen niemals den Server & GPU-Kosten, Ops-Overhead \\
...
\textbf{Nächster Schritt:} Deployed und stabil -- jetzt Observability: Traces (Langfuse), Metriken (Prometheus), SLOs, Cost Alerts, Prompt Drift Detection. Wie du SupportPilot im Betrieb sichtbar und steuerbar machst.
\endinput
